...
class ScholarshipFilterScreen extends StatefulWidget {
  const ScholarshipFilterScreen({super.key});
  ...
  final List<Map<String, dynamic>> scholarships = [
    {
      ...
      "gender": "Any",
      "income": 40000,
      "image": "https://www.universityframes.com/images/scholarship-xs.png?text=SC"
    },
    {
      ...
      "gender": "Female",
      "income": 60000,
      "image": "https://stvurdu.com/wp-content/uploads/2025/07/Top-Government-Scholarships-for-SC-ST-OBC-Students-in-India-2025-Edition-768x768.png?text=OBC"
    },
    {
      "title": "Merit Gen",
      "category": "General",
      "gender": "Any",
      "income": 70000,
      "image": "https://sbnri.com/blog/wp-content/uploads/2022/10/scholarship-indian-students.png?text=Merit"
    },
    {
      ...
      "gender": "Any",
      "income": 80000,
      "image": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRGcqACo-CoycN1n41eljBXCkT_u4BDrl-HlA&s.png?text=General"
    },
    {
      ...
      "gender": "Female",
      "income": 80000,
      "image": "https://e7.pngegg.com/pngimages/681/910/png-clipart-academic-degree-student-master-s-degree-diploma-university-scholarship-people-public-relations.png?text=Reliance"
    },
    {
      ...
      "gender": "Female",
      "income": 80000,
      "image": "https://d2w7l1p59qkl0r.cloudfront.net/blog/uploads/2018/08/01114327/Siouxee-Tour-Guide.png?text=Education"
    },
  ];
                  ...
                  Container(
                    ...
                    child: filtered.isEmpty
                      ...
                      itemBuilder: (context, index) {
                        ...
                        const SizedBox(width: 6),
                        Text("Income ≤ ₹${s['income']}", style: const TextStyle(fontSize: 14)),
                        const Spacer(),
                        const Icon(Icons.person, size: 18, color: Colors.black54),
                        const SizedBox(width: 6),
                        Text("Gender: ${s['gender']}", style: const TextStyle(fontSize: 14)),
                        ],
                        ),
                        ],
                        ),
