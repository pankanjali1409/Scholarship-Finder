...
class class10Screen extends StatefulWidget {
  const class10Screen({super.key});

  @override
  State<class10Screen> createState() => _class10Screen();
}

class _class10Screen extends State<class10Screen> {
  String gender = 'Any';
  String category = 'Any';
  ...
  final List<Map<String, dynamic>> scholarships = [
    {
      ...
      "gender": "Any",
      "income": 40000,
      "image": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTQ6iURg3w7-OAqQYTlb8maGUS1Dy2jTKWXSw&s.png?text=SC"
    },
    {
      ...
      "gender": "Female",
      "income": 60000,
      "image": "https://cache.careers360.mobi/media/article_images/2024/12/10/Scholarships_for_Class_10_Students.jpg?text=OBC"
    },
    {
      "title": "Merit Gen",
      "category": "General",
      "gender": "Any",
      "income": 70000,
      "image": "https://www.successcds.net/wp-content/uploads/2022/09/Pre-Matric-Scholarship-for-SC-Students-Assam.png?text=Merit"
    },
    {
      ...
      "gender": "Any",
      "income": 80000,
      "image": "https://images.tv9hindi.com/wp-content/uploads/2023/03/10th-pass-scholarships.jpg?text=General"
    },
    {
      ...
      "gender": "Female",
      "income": 80000,
      "image": "https://cdn.universitykart.com/Content/upload/admin/hbfapjh5.ouv.png?text=Reliance"
    },
    {
      ...
      "gender": "Female",
      "income": 80000,
      "image": "https://d2w7l1p59qkl0r.cloudfront.net/article/wp-content/uploads/2019/06/04152933/Class-10-Scholarships.jpg?text=Education"
    },
  ];
