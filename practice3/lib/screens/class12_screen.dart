...
class class12Screen extends StatefulWidget {
  const class12Screen({super.key});

  @override
  State<class12Screen> createState() => _class12Screen();
}

class _class12Screen extends State<class12Screen> {
  String gender = 'Any';
  String category = 'Any';
  ...
  final List<Map<String, dynamic>> scholarships = [
    {
      ...
      "gender": "Any",
      "income": 40000,
      "image": "https://cigmafoundation.org/scholarships/wp-content/uploads/2023/09/CBSE-Single-Girl-Child-Scholarship-2023-for-Class-11-12-Students.jpg?text=SC"
    },
    {
      ...
      "gender": "Female",
      "income": 60000,
      "image": "https://sarsaeducation.com/wp-content/uploads/2024/11/12th-class-scholarship-1024x576.png?text=OBC"
    },
    {
      "title": "Merit Gen",
      "category": "General",
      "gender": "Any",
      "income": 70000,
      "image": "https://cache.careers360.mobi/media/article_images/2024/9/18/CBSE-Scholarships.jpg?text=Merit"
    },
    {
      ...
      "gender": "Any",
      "income": 80000,
      "image": "https://sarsaeducation.com/wp-content/uploads/2025/06/Top-Scholarship-for-11th-and-12th-Students.jpeg?text=General"
    },
    {
      ...
      "gender": "Female",
      "income": 80000,
      "image": "https://d2w7l1p59qkl0r.cloudfront.net/article/wp-content/uploads/2025/05/03164254/PM-Scholarship-for-Higher-Education-After-12th-%E2%80%93-Apply-Now.jpg?text=Reliance"
    },
    {
      ...
      "gender": "Female",
      "income": 80000,
      "image": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTruIYH3KHTIpwlb_Z_TyFiIxEqJ_GRgkpSVQ&s.png?text=Education"
    },
  ];
