...
class graduationScreen extends StatefulWidget {
  ...
  @override
  State<graduationScreen> createState() => _graduationScreen();
}

class _graduationScreen extends State<graduationScreen> {
  String gender = 'Any';
  String category = 'Any';
  ...
  final List<Map<String, dynamic>> scholarships = [
    {
      ...
      "gender": "Any",
      "income": 40000,
      "image": "https://www.edupass.org/wp-content/uploads/2020/09/eduPASS-1200_800.png.webp?text=SC"
    },
    {
      ...
      "gender": "Female",
      "income": 60000,
      "image": "https://keystoneacademic-res.cloudinary.com/image/upload/v1729172538/WOMEN_SCHOLARSHIP_5_qmdcxm.png?text=OBC"
    },
    {
      "title": "Merit Gen",
      "category": "General",
      "gender": "Any",
      "income": 70000,
      "image": "https://img.favpng.com/25/18/1/academic-degree-student-master-s-degree-diploma-university-png-favpng-18xywMdpWmD5taa8V0xZEiG3n.jpg?text=Merit"
    },
    {
      ...
      "gender": "Any",
      "income": 80000,
      "image": "https://erasmusplus.ma/wp-content/uploads/2019/10/master-students.jpg?text=General"
    },
    {
      ...
      "gender": "Female",
      "income": 80000,
      "image": "https://assets.thehansindia.com/h-upload/2022/05/17/1292802-degree.webp?text=Reliance"
    },
    {
      ...
      "gender": "Female",
      "income": 80000,
      "image": "https://i.ndtvimg.com/i/2016-12/graduation-generic_650x400_81481305985.jpg?text=Education"
    },
  ];
