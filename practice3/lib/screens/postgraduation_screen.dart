...
class postgraduationScreen extends StatefulWidget {
  const postgraduationScreen({super.key});

  @override
  State<postgraduationScreen> createState() => _postgraduationScreen();
}

class _postgraduationScreen extends State<postgraduationScreen> {
  String gender = 'Any';
  String category = 'Any';
  ...
  final List<Map<String, dynamic>> scholarships = [
    {
      ...
      "gender": "Any",
      "income": 40000,
      "image": "https://www.edvisehub.com/wp-content/uploads/2024/07/Edvise-Hub-Blog-10-1.png?text=SC"
    },
    {
      ...
      "gender": "Female",
      "income": 60000,
      "image": "https://blogs.nottingham.ac.uk/studentlife/files/2017/08/pexels-photo-267885.jpeg?text=OBC"
    },
    {
      "title": "Merit Gen",
      "category": "General",
      "gender": "Any",
      "income": 70000,
      "image": "https://www.thoughtco.com/thmb/l1OSfS8tTZCHmvnBbLUmlEDQSSc=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/graduation-day--1066324992-37c757d3a4594f2c912434f57f267b1a.jpg?text=Merit"
    },
    {
      ...
      "gender": "Any",
      "income": 80000,
      "image": "https://www.myjobmag.co.ke/news/19277HELB%20Postgraduate%20Scholarship.png?text=General"
    },
    {
      ...
      "gender": "Female",
      "income": 80000,
      "image": "https://scholarships360.org/wp-content/uploads/2025/02/Scholarship-Profile-Image-1.png?text=Reliance"
    },
    {
      ...
      "gender": "Female",
      "income": 80000,
      "image": "https://www.ubccu.org/assets/files/5ACV12I0/Scholarship.png?text=Education"
    },
  ];
